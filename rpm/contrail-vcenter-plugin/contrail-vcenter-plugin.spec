...
pushd %{_vcenterplugindir}
%{_maven} install
%{_maven} dependency:copy-dependencies \
  -DincludeScope=runtime \
  -DexcludeGroupIds=net.juniper.contrail
popd
...
install -p -m 755 \
  %{_vcenterplugindir}/target/juniper-contrail-vcenter-3.0-SNAPSHOT.jar \
  %{buildroot}%{_contrailvcenterplugin}/juniper-contrail-vcenter-3.0-SNAPSHOT.jar
ln -s \
